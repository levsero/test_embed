  ...
  describe('reducer', () => {
    ...
    describe('initial state', () => {
      it('form is set to an object with default field props', () => {
        expect(initialState.form).toEqual({
      ...
      it('profile_required is set to false', () => {
        expect(initialState.profile_required).toEqual(false)
      })

      it('required is set to false', () => {
        expect(initialState.required).toEqual(false)
      })
    })
    ...
    describe('when a GET_ACCOUNT_SETTINGS_REQUEST_SUCCESS action is dispatched', () => {
      ...
      it('sets the action payload as the state', () => {
        expect(state).toEqual(settings.forms.pre_chat_form)
      })
    })
