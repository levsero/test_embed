describe('logging config', () => {
  let config;
  const loggingConfigPath = buildSrcPath('service/logging/config');
  ...
  beforeEach(() => {
    ...
    mockery.registerAllowable(loggingConfigPath);
    config = requireUncached(loggingConfigPath);
  });
  ...
  describe('hostBlackList', () => {
    ...
    beforeEach(() => {
      regex = new RegExp(config.hostBlackList[0]);
    });
  ...
  describe('errorMessageBlacklist', () => {
    ...
    beforeEach(() => {
      patternList = config.errorMessageBlacklist;
    });
  ...
  describe('checkIgnoreFn', () => {
    ...
    beforeEach(() => {
      ...
      result = config.checkIgnoreFn(isUncaught, mockArgs);
    });
