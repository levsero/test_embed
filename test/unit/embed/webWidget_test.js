    ...
    describe('when webWidget.refreshLocale is broadcast', () => {
      ...
      describe('when there are custom ticket fields', () => {
        ...
        it('calls getTicketFields', () => {
          expect(getTicketFieldsSpy).toHaveBeenCalledWith(customFields, 'fr')
        })

        it('calls forceUpdate on the child', () => {
          expect(embed.instance.getChild().forceUpdate).toHaveBeenCalled()
        })

        it('does not call getTicketForms', () => {
          expect(getTicketFormsSpy).not.toHaveBeenCalled()
        })
      })
      ...
      describe('when there are ticket forms', () => {
        ...
        it('calls getTicketForms', () => {
          expect(getTicketFormsSpy).toHaveBeenCalledWith(ticketForms, 'fr')
        })

        it('calls updateFrameLocale', () => {
          expect(embed.instance.updateFrameLocale).toHaveBeenCalled()
        })
