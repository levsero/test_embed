describe('Form component', () => {
  ...
  describe('isFormValid', () => {
    let form, result, mockFormState, mockCheckValidity, mockCustomValid
  ...
  describe('handleFormSubmit', () => {
    ...
    beforeEach(() => {
      ...
      form = instanceRender(
        <Form formState={{ email: 'omega@zd.com' }} onCompleted={onCompletedSpy} />
      )
    ...
    it('calls props.onCompleted with the form state', () => {
      expect(onCompletedSpy).toHaveBeenCalledWith({ email: 'omega@zd.com' })
    })
  })

  describe('handleFormChange', () => {
    let form, onChangeSpy, mockFormValidity, formElement
