describe('Dropzone component', () => {
  ...
  describe('classes', () => {
    ...
    describe('when there is no drag active', () => {
      it('Uses classes passed in from the `classNames` prop', () => {
        expect(document.querySelectorAll('.foo').length).not.toEqual(0)
        expect(document.querySelectorAll('.bar').length).toEqual(0)
      })
    })
    ...
    describe('when there is a drag active', () => {
      it('Uses classes passed in from the `classNames` and `activeClassName` props', () => {
        ...
        expect(document.querySelectorAll('.foo').length).not.toEqual(0)
        expect(document.querySelectorAll('.bar').length).not.toEqual(0)
      })
    })
  })
  ...
  describe('onDragEnter', () => {
    ...
    it('should increase the enterCounter', () => {
      expect(dropzone.enterCounter).toEqual(1)
    })

    it('should call the onDragEnter prop', () => {
      expect(dropzone.props.onDragEnter).toHaveBeenCalled()
    })
  ...
  describe('onDragLeave', () => {
    ...
    it('should decrease the enterCounter', () => {
      expect(dropzone.enterCounter).toEqual(0)
    })

    it('should call the onDragLeave prop', () => {
      expect(dropzone.props.onDragLeave).toHaveBeenCalled()
    })
    ...
    describe('when there are multiple children entered', () => {
      ...
      it('should not call the onDragLeave prop', () => {
        expect(dropzone.props.onDragLeave).not.toHaveBeenCalled()
      })
  ...
  describe('onDrop', () => {
    ...
    it('should call the onDrop prop with the dropped files', () => {
      expect(dropzone.props.onDrop).toHaveBeenCalled()
      expect(dropzone.props.onDrop.calls.mostRecent().args[0]).toEqual(files)
    })
  })
})
