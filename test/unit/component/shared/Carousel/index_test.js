describe('Carousel Component', () => {
  ...
  describe('.render', () => {
    ...
    it('should get the correct containerStyle', () => {
      ...
      expect(classNames.indexOf('structuredMessageSlider')).not.toEqual(-1)
      expect(classNames.indexOf('carouselSlider')).not.toEqual(-1)
    })
    ...
    it('should render the children inside Slider component', () => {
      expect(result.props.children.props.children[0]).toEqual(mockChildren)
    })

    it('should pass in correct children length inside Slider component', () => {
      expect(result.props.children.props.children.length).toEqual(mockProps.children.length)
    })
  })
})
