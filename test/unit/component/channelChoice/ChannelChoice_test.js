describe('ChannelChoice component', () => {
  let ChannelChoice, channelChoice
  ...
  beforeEach(() => {
    ...
    initMockRegistry({
      'component/channelChoice/ChannelChoiceDesktop': {
        ChannelChoiceDesktop: noopReactComponent()
      },
      'component/channelChoice/ChannelChoiceMobile': {
        ChannelChoiceMobile: noopReactComponent()
      }
    })
  ...
  describe('render', () => {
    describe('when on desktop', () => {
      ...
      it('should render the ChannelChoiceDesktop component', () => {
        expect(channelChoice.refs.channelChoiceDesktop).toBeDefined()
      })
    })
    ...
    describe('when on mobile', () => {
      ...
      it('should render the ChannelChoiceMobile component', () => {
        expect(channelChoice.refs.channelChoiceMobile).toBeDefined()
      })
    })
  })
  ...
  describe('handleNextClick', () => {
    ...
    beforeEach(() => {
      ...
      channelChoice = domRender(<ChannelChoice onNextClick={onNextClickSpy} />)

      channelChoice.handleNextClick('chat')
    })

    it('should call props.onNextClick with embed param', () => {
      expect(onNextClickSpy).toHaveBeenCalledWith('chat')
    })
  })
})
