describe('Submit ticket component', () => {
  ...
  describe('renderForm', () => {
    ...
    describe('when there is an active ticket form', () => {
      ...
      it('passes down active ticket form fields', () => {
        expect(result.props.ticketFields).toEqual(mockActiveTicketFormFields)
      })

      it('the passed fields do not match ticket fields from config', () => {
        expect(result.props.ticketFields).not.toEqual(mockTicketFields)
      })
    ...
    describe('when an active form does not exist', () => {
      ...
      it('passes down ticket fields from config', () => {
        expect(result.props.ticketFields).toEqual(mockTicketFields)
      })

      it('the passed fields do not match active ticket fields for a form', () => {
        expect(result.props.ticketFields).not.toEqual(mockActiveTicketFormFields)
      })
    })
  })

  describe('#renderErrorMessage', () => {
    let component, result, errorMessage

    beforeEach(() => {
      component = instanceRender(<SubmitTicket errorMsg={errorMessage} />)
  ...
  describe('#handleSubmit', () => {
    let submitTicket, mockHandleTicketSubmission, mockOnSubmitted, mockValues
    ...
    describe('when the form is invalid', () => {
      ...
      it('does not call props.handleTicketSubmission', () => {
        expect(mockHandleTicketSubmission).not.toHaveBeenCalled()
      })
    })
    ...
    describe('when the form is valid', () => {
      ...
      describe('when there is a successful response', () => {
        ...
        it('clears the form', () => {
          expect(submitTicket.clearForm).toHaveBeenCalled()
        })
        ...
        it('calls onSubmitted with given last search', () => {
          expect(mockOnSubmitted.calls.mostRecent().args[0].searchTerm).toEqual('a search')

          expect(mockOnSubmitted.calls.mostRecent().args[0].searchLocale).toEqual('en-US')
        })

        it('calls onSubmitted with the attachments list state', () => {
          expect(mockOnSubmitted.calls.mostRecent().args[0].attachmentsCount).toEqual(2)

          expect(mockOnSubmitted.calls.mostRecent().args[0].attachmentTypes).toEqual([
            'image/png',
  ...
  describe('renderNotification', () => {
    let notification, mockHideZendeskLogo, mockIsMobile, mockIsFullscreen
    ...
    it('should render SuccessNotification', () => {
      expect(TestUtils.isElementOfType(notification.props.children, SuccessNotification)).toEqual(
        true
      )
    })
    ...
    describe('when fullscreen and isMobile are true', () => {
      ...
      it('passes isMobile to child', () => {
        expect(notification.props.isMobile).toEqual(true)
      })
    ...
    describe('when hideZendeskLogo is true', () => {
      ...
      it('renders noZendeskLogoButton', () => {
        expect(notification.props.footerContent.props.className).toContain('noZendeskLogoButton')
      })

      it('does not renders zendeskLogoButton', () => {
        expect(notification.props.footerContent.props.className).not.toContain('zendeskLogoButton')
      })
    })
    ...
    describe('when zendesk logo required', () => {
      ...
      it('renders zendeskLogoButton', () => {
        expect(notification.props.footerContent.props.className).toContain('zendeskLogoButton')
      })

      it('does not render noZendeskLogoButton', () => {
        expect(notification.props.footerContent.props.className).not.toContain(
          'noZendeskLogoButton'
        )
      })
    })
  ...
  describe('ticket forms list', () => {
    ...
    it('is rendered by default', () => {
      ...
      expect(submitTicket.refs.ticketFormSelector).toBeUndefined()
    })
    ...
    it('is rendered when there is more then one ticket form', () => {
      ...
      expect(submitTicket.refs.ticketFormSelector).toBeDefined()
    })
    ...
    it('renders the correct number of list options', () => {
      ...
      expect(submitTicket.renderTicketFormOptions().length).toBe(3)
    })
    ...
    it('renders a semantically appropriate un-numbered list', () => {
      ...
      expect(submitTicket.renderTicketFormOptions().map(el => el.type)).toEqual(['li', 'li', 'li'])
    })
  })
  ...
  describe('loading spinner', () => {
    ...
    describe('when loading is false', () => {
      ...
      it('does not render', () => {
        expect(submitTicketNode.querySelectorAll('.loadingSpinnerClasses').length).toEqual(0)
      })
    })
    ...
    describe('when loading is true', () => {
      ...
      it('renders', () => {
        expect(submitTicketNode.querySelectorAll('.loadingSpinnerClasses').length).toEqual(1)
      })

      it('does not have extra padding by default', () => {
        expect(submitTicketNode.querySelectorAll('.loadingSpinnerIEClasses').length).toEqual(0)
      })
      ...
      describe('when on IE', () => {
        ...
        it('has extra padding', () => {
          expect(submitTicketNode.querySelectorAll('.loadingSpinnerIEClasses').length).toEqual(1)
        })
      })
    })
  })
  ...
  it('should pass on fullscreen to submitTicketForm', () => {
    ...
    expect(submitTicket.state.fullscreen).toEqual('VALUE')
  })
  ...
  it('pass isMobile to submitTicketForm', () => {
    ...
    expect(submitTicket.state.isMobile).toEqual('VALUE')
  })
  ...
  describe('attachmentBox', () => {
    it('should display the attachment box when isDragActive and attachmentsEnabled are true', () => {
      ...
      expect(submitTicket.state.isDragActive).toEqual(true)

      expect(document.querySelectorAll('.attachment_box').length).toEqual(1)
    })
    ...
    it('should not display the attachment box if attachmentsEnabled is false', () => {
      ...
      expect(document.querySelectorAll('.attachment_box').length).toEqual(0)
    })
  })
  ...
  describe('clearForm', () => {
    ...
    describe('when there is more than 1 ticket form', () => {
      ...
      it('calls handleTicketFormClick with null', () => {
        expect(handleTicketFormClickSpy).toHaveBeenCalledWith(null)
      })
    })
    ...
    describe('when there is 1 ticket form', () => {
      ...
      it('does not call handleTicketFormClick', () => {
        expect(handleTicketFormClickSpy).not.toHaveBeenCalled()
      })
    })
  })

  describe('setTicketForm', () => {
    let submitTicket, mockShowBackButton
    ...
    describe('when there are no ticket forms', () => {
      ...
      beforeEach(() => {
        ...
        submitTicket = domRender(
          <SubmitTicket showBackButton={mockShowBackButton} ticketForms={[]} />
        )
      })
      ...
      describe('when it is passed any data type representing a ticketFormId', () => {
        it('does not call showBackButton', () => {
          ...
          expect(mockShowBackButton).not.toHaveBeenCalled()
        })
      })
    })
