describe('ChatOperatingHours component', () => {
  ...
  describe('render', () => {
    ...
    beforeEach(() => {
      component = instanceRender(<ChatOperatingHours operatingHours={mockAccountOperatingHours} />)
  ...
  describe('use locales specific clock', () => {
    ...
    it('passes locale correctly to i18nTimeFromMinutes', () => {
      ...
      expect(i18nTimeFromMinutes).toHaveBeenCalledWith(456, locale)
      expect(i18nTimeFromMinutes).toHaveBeenCalledWith(789, locale)
    })
  })
  ...
  describe('setActiveDepartment', () => {
    ...
    it('calls setState with the selected department', () => {
      expect(component.setState).toHaveBeenCalledWith({ activeDepartment: 123 })
    })
  })
  ...
  describe('getSelectedDepartmentSchedule', () => {
    ...
    it('returns the selected department', () => {
      expect(result).toEqual(mockDepartmentOperatingHours.department_schedule[1])
    })
  })
  ...
  describe('renderDepartmentSchedule', () => {
    ...
    describe('when department operating hours exist', () => {
      ...
      it('calls renderSchedule with the departments schedule', () => {
        expect(component.renderSchedule).toHaveBeenCalledWith('mockSelectedDept')
      })
    })
  ...
  describe('renderAccountSchedule', () => {
    ...
    describe('when account operating hours exist', () => {
      ...
      it('calls renderSchedule with the account schedule', () => {
        expect(component.renderSchedule).toHaveBeenCalledWith(
          mockAccountOperatingHours.account_schedule
        )
      })
    })
  ...
  describe('renderSchedule', () => {
    let component, result, dayName, range, operatingHours

    beforeEach(() => {
      component = instanceRender(<ChatOperatingHours operatingHours={operatingHours} />)
      result = component.renderSchedule(
        operatingHours.account_schedule || operatingHours.department_schedule[0].schedule
      )
    })
