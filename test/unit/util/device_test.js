describe('devices', function() {
  ...
  describe('isBlacklisted', function() {
    ...
    it('returns true if chrome browser on os 8 is within the user agent string', function() {
      /* jshint maxlen: false */
    ...
    it('returns false if chrome browser before os 8 is within the user agent string', function() {
      /* jshint maxlen: false */
