...
export const API_ON_CHAT_POPOUT = 'popout'

// get api params
export const API_GET_IS_CHATTING_NAME = 'isChatting'
export const API_GET_DEPARTMENTS_ALL_NAME = 'departments'
export const API_GET_DEPARTMENTS_DEPARTMENT_NAME = 'department'
