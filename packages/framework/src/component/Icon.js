...
const icons = {
  Icon: require('src/asset/icons/widget-icon_help.svg'),
  [ICONS.DASH]: require('src/asset/icons/widget-icon_dash.svg'),
  [ICONS.ERROR_FILL]: require('@zendeskgarden/svg-icons/src/14/error-fill.svg'),
  [ICONS.SEND_CHAT]: require('src/asset/icons/widget-icon_sendChat.svg'),
  [ICONS.AGENT_AVATAR]: require('src/asset/icons/widget-icon_avatar.svg'),
  'Icon--clock-stroke': require('@zendeskgarden/svg-icons/src/16/clock-stroke.svg'),
  [ICONS.AVATAR]: require('src/asset/icons/widget-icon_concierge.svg'),
  [ICONS.CC_SUPPORT]: require('src/asset/icons/widget-icon_channelChoice-contactForm.svg'),
  [ICONS.CC_TALK]: require('src/asset/icons/widget-icon_channelChoice-talk.svg'),
  [ICONS.CC_CLICK_TO_CALL]: require('src/embeds/talk/icons/channel_choice_click_to_call.svg'),
  [ICONS.CHAT]: require('src/asset/icons/widget-icon_chat.svg'),
  ...
  'Icon--sound-off': require('src/asset/icons/widget-icon_sound_off.svg'),
  'Icon--sound-on': require('src/asset/icons/widget-icon_sound_on.svg'),
  ...
  'Icon--zendesk': require('src/asset/icons/widget-icon_zendesk.svg'),
  'Icon--trash-fill': require('@zendeskgarden/svg-icons/src/16/trash-fill.svg'),
  [ICONS.CC_CHAT]: require('src/asset/icons/widget-icon_channelChoice-chat.svg'),
