describe('helpCenter selectors', () => {
  ...
  describe('getIsShowHCIntroState', () => {
    let result, mockActiveArticle, mockManualContextualSuggestions, mockHasSearched
  ...
  describe('getContextualHelpRequestNeeded', () => {
    let result, mockManualContextualSuggestions
  ...
  describe('getHasSearched', () => {
    let result, mockHelpCenterState
  ...
  describe('getIsContextualSearchPending', () => {
    let result, mockContextualSearchScreen
