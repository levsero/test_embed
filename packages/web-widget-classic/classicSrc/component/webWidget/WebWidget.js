...
import OnBackProvider from 'classicSrc/component/webWidget/OnBackProvider'
import ChatNotificationPopup from 'classicSrc/components/NotificationPopup'
import SuspensePage from 'classicSrc/components/Widget/SuspensePage'
import { screenChanged as updateAnswerBotScreen } from 'classicSrc/embeds/answerBot/actions/root'
import { CONVERSATION_SCREEN } from 'classicSrc/embeds/answerBot/constants'
import {
  getStandaloneMobileNotificationVisible,
  getShowChatHistory,
} from 'classicSrc/embeds/chat/selectors'
import { closeCurrentArticle } from 'classicSrc/embeds/helpCenter/actions'
import ChannelChoicePage from 'classicSrc/embeds/webWidget/pages/ChannelChoicePage'
import {
  updateActiveEmbed,
...
import { getActiveEmbed, getWebWidgetOpen } from 'classicSrc/redux/modules/base/base-selectors'
import {
...
import { getSettingsMobileNotificationsDisabled } from 'classicSrc/redux/modules/settings/settings-selectors'
...
const Talk = lazy(() => import(/* webpackChunkName: 'lazy/talk' */ 'classicSrc/embeds/talk'))
const HelpCenter = lazy(() =>
  import(/* webpackChunkName: 'lazy/help_center' */ 'classicSrc/embeds/helpCenter')
)
const Support = lazy(() =>
  import(/* webpackChunkName: 'lazy/support' */ 'classicSrc/embeds/support')
)
const AnswerBot = lazy(() =>
  import(/* webpackChunkName: 'lazy/answerBot' */ 'classicSrc/embeds/answerBot')
)
const Chat = lazy(() =>
  import(/* webpackChunkName: 'lazy/chat' */ 'classicSrc/component/chat/Chat')
)
