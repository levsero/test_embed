...
import { render, dispatchChatAccountSettings } from 'classicSrc/util/testHelpers'
import ChatOnline from '../../ChatOnline'

jest.mock('classicSrc/service/transport/http')
jest.mock('classicSrc/embeds/chat/components/ImageMessage', () => () => <div>ImageMessage</div>)
