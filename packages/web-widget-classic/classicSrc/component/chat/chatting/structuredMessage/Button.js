import { Button as PureButton } from 'classicSrc/component/shared/StructuredMessage/pure/Button'
import { CHAT_STRUCTURED_MESSAGE_ACTION_TYPE } from 'classicSrc/constants/chat'
...
export class Button extends Component {
  ...
  render() {
    ...
    return <PureButton label={text} onClick={createAction(action)} />
  }
}
