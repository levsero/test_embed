...
import { widgetShowAnimationComplete } from 'classicSrc/redux/modules/base/base-actions'
import { getChatStandalone, getLocale } from 'classicSrc/redux/modules/base/base-selectors'
import {
  getFixedStyles,
  getColor,
