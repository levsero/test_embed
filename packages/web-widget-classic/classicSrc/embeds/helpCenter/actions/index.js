...
import { MAXIMUM_SEARCH_RESULTS } from 'classicSrc/constants/helpCenter'
import { MAXIMUM_CONTEXTUAL_SEARCH_RESULTS } from 'classicSrc/constants/helpCenter'
import {
...
import { updateQueue, authenticate, expireToken } from 'classicSrc/redux/modules/base'
import {
  getAuthToken,
  getHasWidgetShown,
  getIsAuthenticationPending,
} from 'classicSrc/redux/modules/base/base-selectors'
import { getHasPassedAuth } from 'classicSrc/redux/modules/selectors/helpCenter-linked-selectors'
import {
