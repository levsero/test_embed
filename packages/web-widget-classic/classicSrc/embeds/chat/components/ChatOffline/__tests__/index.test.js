...
jest.mock('classicSrc/embeds/chat/pages/OfflineFormPage', () => () => <div>ChatOfflineForm</div>)

jest.mock('classicSrc/embeds/chat/pages/OperatingHoursPage', () => () => (
  <div>OperatingHoursPage</div>
))
