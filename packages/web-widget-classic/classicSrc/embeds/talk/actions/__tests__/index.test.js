import * as types from 'classicSrc/embeds/talk/action-types'
import * as actions from 'classicSrc/embeds/talk/actions'
import { MAX_TALK_POLL_INTERVAL, BASE_TALK_POLL_INTERVAL } from 'classicSrc/embeds/talk/constants'
import createStore from 'classicSrc/redux/createStore'
import * as baseTypes from 'classicSrc/redux/modules/base/base-action-types'
import * as baseSelectors from 'classicSrc/redux/modules/selectors/selectors'
