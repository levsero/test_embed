import { ATTACHMENT_ERRORS } from 'classicSrc/embeds/support/constants'
...
import formatRequestData from 'classicSrc/embeds/support/utils/requestFormatter'
import { clearFormState } from 'classicSrc/redux/modules/form/actions'
import history from 'classicSrc/service/history'
import { http } from 'classicSrc/service/transport'
import { queuesReset } from 'classicSrc/util/rateLimiting/helpers'
...
jest.mock('classicSrc/embeds/support/utils/attachment-sender')
jest.mock('classicSrc/embeds/support/utils/requestFormatter')
jest.mock('classicSrc/service/history')
jest.mock('@zendesk/widget-shared-services/feature-flags')
jest.mock('classicSrc/embeds/support/utils/track-ticket-submitted')
