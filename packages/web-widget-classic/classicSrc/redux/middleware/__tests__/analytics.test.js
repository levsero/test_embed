...
import { FORM_OPENED } from 'classicSrc/embeds/support/actions/action-types'
import { TICKET_SUBMISSION_REQUEST_SUCCESS } from 'classicSrc/embeds/support/actions/action-types'
import { TALK_CALLBACK_SUCCESS } from 'classicSrc/embeds/talk/action-types'
import { PHONE_ONLY, CLICK_TO_CALL } from 'classicSrc/embeds/talk/talk-capability-types'
import {
  UPDATE_ACTIVE_EMBED,
  UPDATE_WIDGET_SHOWN,
