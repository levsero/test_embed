import { USER_EVENT } from 'classicSrc/constants/event'
import { GA_CATEGORY } from 'classicSrc/constants/shared'
import { ARTICLE_SHOWN } from 'classicSrc/embeds/answerBot/actions/root/action-types'
import { getArticleForArticleAndSessionsID } from 'classicSrc/embeds/answerBot/selectors/root'
import { getDepartments } from 'classicSrc/embeds/chat/selectors'
import {
  SEARCH_REQUEST_SUCCESS,
  ARTICLE_VIEWED,
  ORIGINAL_ARTICLE_CLICKED,
} from 'classicSrc/embeds/helpCenter/actions/action-types'
import { getSearchTerm } from 'classicSrc/embeds/helpCenter/selectors'
import { getCurrentActiveArticle, getArticles } from 'classicSrc/embeds/helpCenter/selectors/index'
import {
...
import { getForm } from 'classicSrc/embeds/support/selectors'
import { TALK_CALLBACK_SUCCESS } from 'classicSrc/embeds/talk/action-types'
import { CAPABILTY_NAMES } from 'classicSrc/embeds/talk/constants'
...
import { getAnalyticsDisabled } from 'classicSrc/redux/modules/settings/settings-selectors'
