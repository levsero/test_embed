...
} from 'classicSrc/redux/modules/selectors/chat-linked-selectors'
import {
  getCanShowHelpCenterIntroState,
  getHelpCenterAvailable,
  getHelpCenterReady,
} from 'classicSrc/redux/modules/selectors/helpCenter-linked-selectors'
import { settings } from 'classicSrc/service/settings'
import _ from 'lodash'
import { createSelector } from 'reselect'
import { isPopout, getZendeskHost, isMobileBrowser } from '@zendesk/widget-shared-services'
import {
  getActiveEmbed,
  getHelpCenterEmbed,
...
export const getFrameVisible = (state, frame = 'webWidget') => {
  if (frame === 'webWidget' || frame === 'ipmWidget') {
    return getWebWidgetVisibleOpenAndReady(state)
  }
