...
import * as setupChatActions from 'classicSrc/embeds/chat/actions/setup-chat'
...
jest.mock('classicSrc/service/api/zopimApi')
jest.mock('classicSrc/redux/modules/chat/helpers/firehoseListener')
