...
import { updateBackButtonVisibility, showWidget, showChat } from 'classicSrc/redux/modules/base'
import { getActiveEmbed } from 'classicSrc/redux/modules/base/base-selectors'
import {
  zChatWithTimeout,
  canBeIgnored,
} from 'classicSrc/redux/modules/chat/helpers/zChatWithTimeout'
...
const loadAudio = () => {
  import(
    /* webpackChunkName: 'chat-incoming-message-notification' */ 'classicSrc/asset/media/chat-incoming-message-notification.mp3'
  )
    .then((result) => {
