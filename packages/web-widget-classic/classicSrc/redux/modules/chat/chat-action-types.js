...
export const GET_ACCOUNT_SETTINGS_REQUEST_SUCCESS =
  'widget/chat/GET_ACCOUNT_SETTINGS_REQUEST_SUCCESS'
...
export const CHAT_LAST_CHAT_RATING_REQUEST_COMPLETE =
  'widget/chat/CHAT_LAST_CHAT_RATING_REQUEST_COMPLETE'
...
export const PROACTIVE_CHAT_NOTIFICATION_DISMISSED =
  'widget/chat/PROACTIVE_CHAT_NOTIFICATION_DISMISSED'
...
export const OFFLINE_FORM_OPERATING_HOURS_LINK_CLICKED =
  'widget/chat/OFFLINE_FORM_OPERATING_HOURS_LINK_CLICKED'
export const CHAT_RECONNECT = 'widget/chat/CHAT_RECONNECT'
export const UPDATE_CHAT_CONTACT_DETAILS_VISIBILITY =
  'widget/chat/UPDATE_CHAT_CONTACT_DETAILS_VISIBILITY'
export const UPDATE_CHAT_EMAIL_TRANSCRIPT_VISIBILITY =
...
export const CHAT_DROPPED = 'widget/chat/CHAT_DROPPED'
