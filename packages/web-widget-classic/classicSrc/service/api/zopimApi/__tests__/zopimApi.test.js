...
import * as baseActions from 'classicSrc/redux/modules/base'
import * as baseSelectors from 'classicSrc/redux/modules/base/base-selectors'
import * as chatActions from 'classicSrc/redux/modules/chat'
import * as chatLinkedSelectors from 'classicSrc/redux/modules/selectors/chat-linked-selectors'
import * as apis from 'classicSrc/service/api/apis'
...
jest.mock('classicSrc/embeds/chat/selectors')
jest.mock('classicSrc/redux/modules/base/base-selectors')
jest.mock('classicSrc/redux/modules/selectors/chat-linked-selectors')
...
describe('setupZopimQueue', () => {
  describe('when $zopim has been defined on the window', () => {
    let mockWin
    ...
    it('preserves the existing queue', () => {
