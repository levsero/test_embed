...
function createTicketForm(fieldIds) {
  ...
  const ticketFormRequest = http.request(options, function(res) {
  ...
  ticketFormRequest.on('error', function(e) {
...
function createTicketFields() {
  ...
  _.forEach(fields, (field) => {
    const ticketFieldsRequest = http.request(options, function(res) {
    ...
    ticketFieldsRequest.on('error', function(e) {
