...
describe('ticket form list', () => {
  ...
  describe('when a form is selected', () => {
    it('fires the handleFormOptionClick', () => {
      const handleFormOptionClick = jest.fn(e => e.persist()) // https://reactjs.org/docs/events.html#event-pooling
      ...
      const buttonElem = handleFormOptionClick.mock.calls[0][0].target

      expect(buttonElem.getAttribute('data-id')).toEqual('3')
    })
  })
})
