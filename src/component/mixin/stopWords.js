...
export var stopWords = [
  ...
  'furthering','furthers','g','gave','general','generally','get','gets','give','given','gives','go','going','good','goods','got','great','greater',
  'greatest','group','grouped','grouping','groups','h','had','hadn\'t','has','hasn\'t','have','haven\'t','having','he','he\'d','he\'ll','her','here',
  'here\'s','hers','herself','he\'s','high','higher','highest','him','himself','his','how','however','how\'s','i','i\'d','if','i\'ll','i\'m','important',
  'in','interest','interested','interesting','interests','into','is','isn\'t','it','its','it\'s','itself','i\'ve','j','just','k','keep','keeps','kind',
  ...
  'small','smaller','smallest','so','some','somebody','someone','something','somewhere','state','states','still','such','sure','t','take','taken','than',
  'that','that\'s','the','their','theirs','them','themselves','then','there','therefore','there\'s','these','they','they\'d','they\'ll','they\'re','they\'ve',
  'thing','things','think','thinks','this','those','though','thought','thoughts','three','through','thus','to','today','together','too','took','toward','turn',
  'turned','turning','turns','two','u','under','until','up','upon','us','use','used','uses','v','very','w','want','wanted','wanting','wants','was','wasn\'t',
  'way','ways','we','we\'d','well','we\'ll','wells','went','were','we\'re','weren\'t','we\'ve','what','what\'s','when','when\'s','where','where\'s','whether',
  'which','while','who','whole','whom','who\'s','whose','why','why\'s','will','with','within','without','won\'t','work','worked','working','works','would',
