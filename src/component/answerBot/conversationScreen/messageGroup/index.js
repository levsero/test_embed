...
class MessageGroup extends Component {
  ...
  isNewMessage = (timestamp, lastConversationScreenClosed) => {
    return (
      timestamp > lastConversationScreenClosed &&
  ...
  renderMessages = (messages, lastConversationScreenClosed) => {
    ...
    } else { // For bot, both delay and animation
...
const ConnectedMessageGroup = connect(makeMapStateToProps, {}, null, { withRef: true })(MessageGroup);
