...
export const countriesByIso = {
  ...
  'AG': { code: '1-268', name: 'Antigua and Barbuda' },
  ...
  'DO': { code: '1-809, 1-829, 1-849', name: 'Dominican Republic' },
  ...
  'PR': { code: '1-787, 1-939', name: 'Puerto Rico' },
  ...
  'KN': { code: '1-869', name: 'Saint Kitts and Nevis' },
  'LC': { code: '1-758', name: 'Saint Lucia' },
  'MF': { code: '590', name: 'Saint Martin' },
  'PM': { code: '508', name: 'Saint Pierre and Miquelon' },
  'VC': { code: '1-784', name: 'Saint Vincent and the Grenadines' },
  ...
  'TT': { code: '1-868', name: 'Trinidad and Tobago' },
  'TN': { code: '216', name: 'Tunisia' },
  'TR': { code: '90', name: 'Turkey' },
  'TM': { code: '993', name: 'Turkmenistan' },
  'TC': { code: '1-649', name: 'Turks and Caicos Islands' },
