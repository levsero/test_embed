...
test('renders the expected components', () => {
  const { container } = renderComponent({ searchPlaceholder: 'How can we help?', title: 'hello' });
...
describe('render', () => {
  ...
  describe('show channelChoice options', () => {
    it('show channel choice when channelChoice is true', () => {
      ...
      expect(queryByText('Leave a message'))
        .toBeInTheDocument();
    });
  ...
  describe('footer content', () => {
    it('renders footer buttons when showNextButton and articleViewActive is true', () => {
      ...
      expect(queryByText('Leave us a message'))
        .toBeInTheDocument();
    });
...
describe('search box clicked', () => {
  it('changes screen when search box is clicked', () => {
    const { queryByText, getByPlaceholderText } = renderComponent({ searchPlaceholder: 'How can we help?' });
