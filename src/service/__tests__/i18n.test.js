...
describe('i18n', () => {
  ...
  describe('setLocale', () => {
    ...
    it.each([
      ...
      ['tl', 'tl'],
      ['en-AU', 'en-au']
    ])('setLocale(%s) resolves to %s', (arg, expected) => {
      i18n.setLocale(arg)
  ...
  describe('getSettingTranslation', () => {
    ...
    describe('when the translations object is empty', () => {
      it('returns undefined', () => {
        expect(getSettingTranslation('en-US', {})).toEqual(undefined)
      })
    })
