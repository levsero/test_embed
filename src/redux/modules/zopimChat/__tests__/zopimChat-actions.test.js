...
test('updateZopimChatStatus dispatches expected action', () => {
  ...
  expect(actions.updateZopimChatStatus('blah')).toEqual(expected)
})
...
test('zopimHide dispatches expected action', () => {
  ...
  expect(actions.zopimHide()).toEqual(expected)
})
...
test('zopimShow dispatches expected action', () => {
  ...
  expect(actions.zopimShow()).toEqual(expected)
})
...
test('zopimConnectionUpdate dispatches expected action', () => {
  ...
  expect(actions.zopimConnectionUpdate()).toEqual(expected)
})
...
test('zopimIsChatting dispatches expected action', () => {
  ...
  expect(actions.zopimIsChatting()).toEqual(expected)
})
...
test('zopimChatGoneOffline dispatches expected action', () => {
  ...
  expect(actions.zopimChatGoneOffline()).toEqual(expected)
})
...
test('zopimOpen dispatches expected action', () => {
  ...
  expect(actions.zopimOpen()).toEqual(expected)
})
...
test('zopimClose dispatches expected action', () => {
  ...
  expect(actions.zopimClose()).toEqual(expected)
})
...
test('zopimOnClose dispatches expected action', () => {
  ...
  expect(store.getActions()).toEqual([{ type: types.ZOPIM_ON_CLOSE }])
