...
export const getShowOperatingHours = (state) => chatState(state).accountSettings.operatingHours.display_notice;
...
export const getStandaloneMobileNotificationVisible = (state) => chatState(state).standaloneMobileNotificationVisible;
...
export const getChatAccountSettingsOfflineForm = (state) => chatState(state).accountSettings.offlineForm;
export const getChatAccountSettingsPrechatForm = (state) => chatState(state).accountSettings.prechatForm;
